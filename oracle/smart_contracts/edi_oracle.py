...
# It is best practice to store static values in boxes
# to avoid high minimum balance requirements
# This function converts a string to a fixed length byte array
# by appending a - followed by 0s
